...
function Home(props) {
  return (
    <div className="container-fluid">
      <div className="m-5">
      <p className="hero-legend justify-content-center pt-5 ">Connect, Collaborate, and Reunite</p>
      </div>
      <div>
        <p className="home-inner justify-content-center">A Lost & Found for Your Freelance Community</p>
      </div>
      ...
      <div className="home-inner2 p-5 ">
        ...
        <p className="home-inner3 mt-4 p-3">Join CONNECT, the trusted network for freelancing professionals</p>
      ...
      <p className="home-targeted-search-body p-3">Find what you're looking for quickly with advanced filtering and categorization based on project types, skills, and locations.</p>
      </div>
      <div className="home-banner-inner m-5">
        <div className="home-banner-secure m-5">
          ...
          <p className="home-banner-secure-inner1">Join CONNECT, the trusted network for freelancing professionals</p>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="p-3 text-center">
              ...
              <p className="home-banner-community-inner p-3">Join CONNECT, the trusted network for freelancing professionals</p>
              <button className="btn btn-outline-info btn-lg px-5 pt-3 my-3" id="btn2">GROW  <i className="bi bi-gear-wide-connected mx-1"></i></button>
            </div>
          </div>
          <div className="col-md-6">
              <img src={side_fig} alt="side figure" className="img-fluid  p-3"/>
          </div>
        </div>
      </div>
      ...
      <div className="home-banner-inner text-center p-4 m-5">
        ...
        <p className="home-banner-quoteblock m-5">" Connect restored my faith in the freelance community. My Code went missing after a shoot, and within days, a fellow Coder  messaged me through the platform to return it! Amazing! "</p>
