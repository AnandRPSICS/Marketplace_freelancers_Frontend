          ...
          <div className="col-md-8 col-lg-6 col-xxl-3">
            <div className="card mb-0">
              <div className="card-body">
                ...
                <h2 className="text-center fw-semibold">Freelancer Login</h2>
                <form>
                  <div className="mb-3">
                  ...
                  <a href="" className="btn btn-secondary w-100 py-8 fs-4 mb-4 rounded-2">Sign In</a>
                  <p className='d-flex align-items-center justify-content-center mb-0 fw-bold'>New to Freelancerz?</p>
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-5 mb-0 fw-bold"><a class="text-primary fw-bold ms-2" href=""> Create an account</a></p>
